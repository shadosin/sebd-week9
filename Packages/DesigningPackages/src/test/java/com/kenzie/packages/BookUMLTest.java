...
public class BookUMLTest {
    ...
    void bookUML_File_LibraryBook_Methods() throws Exception {
        ...
        assertEquals(2,numTimesWordFoundInString(valueFromXml.toLowerCase(), "librarybook("),  "Be sure to include the correct type of class constructors for the LibraryBook class");
    ...
    private int numTimesCharInString(String stringToCheck, char charToFind) {
        ...
        for (int i = 0; i < stringToCheck.length(); i++) {
            if (stringToCheck.charAt(i) == charToFind) {
                count++;
            }
        }
