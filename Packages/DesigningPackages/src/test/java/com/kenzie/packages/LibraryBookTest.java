...
public class LibraryBookTest {
    ...
    void libraryBookClass_hasZero_Parameter_Constructor() throws NoSuchElementException{
        try {
            ...
            try {
                ...
                assertEquals("", getSubjectListResult, "isbn Should be initialized, double check your constructor.");
    ...
    void libraryBookClass_hasTwo_Parameter_Constructor() throws NoSuchElementException{
        try {
            String isbnExpected = "My Isbn";

            String subjectListExpected = "My Subject List";

            Object [] LIBRARY_BOOK_CLASS_TWO_PARAMETER_CONSTRUCTOR_VALUES = {isbnExpected, subjectListExpected};
            ...
            try {
                ...
                setIsbn.invoke(libraryBook, isbnExpected);
                ...
                setSubjectList.invoke(libraryBook, subjectListExpected);

                Method getSubjectList = LibraryBook.class.getMethod("getSubjectList");

                String getSubjectListResult = (String)getSubjectList.invoke(libraryBook);

                assertEquals(isbnExpected, getIsbnResult, "isbn Should be initialized to the correct value, double check your constructor.");

                assertEquals(subjectListExpected, getSubjectListResult, "subjectList Should be initialized to the correct value, double check your constructor.");
